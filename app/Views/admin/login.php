...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Ekart</b>application</a>
  </div>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <h6 class="text-danger"><?php if(session()->has("error")){echo session("error");}?></h6>

       <span class="text-danger"><?= isset($validation) ? display_error($validation, 'username'): ''?> </span>

      <form action="<?php echo base_url().'/login/authenticate';?>" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" id="username" value="<?= set_value('username') ?>" class="form-control" placeholder="Username">
       ...
       <h6 class="text-danger"><?php if(session()->has("fail")){echo session("fail");}?></h6>
